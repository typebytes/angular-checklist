...
import { faBan, faBell, faHandsHelping, faHeart, faInfo, faLanguage } from '@fortawesome/free-solid-svg-icons';
...
library.add(faGithub, faTwitter, faHeart, faHandsHelping, faBell, faBan, faInfo, faLanguage);
